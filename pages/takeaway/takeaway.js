...
Page({
  ...
  data: {
    ...
    imgUrls0: [
      {
        title: '美团外卖红包领不停',
        imgUrl: 'https://huadong-hz.oss-cn-hangzhou.aliyuncs.com/mini/meituan-hb.png',
      ...
      {
        title: '每日领取饿了么专属红包',
        imgUrl: 'https://huadong-hz.oss-cn-hangzhou.aliyuncs.com/mini/ele-hongbao.jpeg',
        appId: 'wxece3a9a4c82f58c9',
        path: 'pages/index/index?realUrl=ele-recommend-price%2Fpages%2Fguest%2Findex%3FinviterId%3D1db91dca&chInfo=ch_wechat_chsub_CopyLink&_ltracker_f=tjyj1_wx_banner3'
      },
      {
        title: '饿了么果蔬商超优惠券',
        imgUrl: 'https://huadong-hz.oss-cn-hangzhou.aliyuncs.com/mini/ele-31.jpg',
        appId: 'wxece3a9a4c82f58c9',
        path: 'pages/index/index?realUrl=https://s.click.ele.me/QbpgDlu'
      },
